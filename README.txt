...
The client utility for interfacing with SQLite that will be used for the session is DBeaver, a free program available for download from https://dbeaver.io/ 
...
Ensure to download the Community Edition and follow prompts for the installation
  a. After installing dbeaver, ensure to set up a SQLite database connection
  b. Define the PATH to the database file point to a location within your Documents folder:
=======
1. Please go to https://dbeaver.io/ and download and install the dbeaver app
  a. After installing dbeaver, ensure to set up a SQLite database connection
  b. Define the PATH to the database file to a location within your Documents folder:
>>>>>>> b4b69a9fa76291a4405c14e8035af69f078b5d1a
